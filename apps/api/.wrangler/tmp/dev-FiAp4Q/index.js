...
// .wrangler/tmp/bundle-7ehyWE/checked-fetch.js
...
var require_index_browser = __commonJS({
  "../../node_modules/.pnpm/@prisma+client@5.22.0_prisma@5.22.0/node_modules/@prisma/client/runtime/index-browser.js"(exports, module) {
    ...
    var Xe = /* @__PURE__ */ __name((e, n, i, t) => {
      if (n && typeof n == "object" || typeof n == "function") for (let r of Ge(n)) !Je.call(e, r) && r !== i && de(e, r, { get: /* @__PURE__ */ __name(() => n[r], "get"), enumerable: !(t = We(n, r)) || t.enumerable });
      return e;
    }, "Xe");
    var Ke = /* @__PURE__ */ __name((e) => Xe(de({}, "__esModule", { value: true }), e), "Ke");
    var Xn = {};
    Me(Xn, { Decimal: /* @__PURE__ */ __name(() => je, "Decimal"), Public: /* @__PURE__ */ __name(() => he, "Public"), getRuntime: /* @__PURE__ */ __name(() => be, "getRuntime"), makeStrictEnum: /* @__PURE__ */ __name(() => Pe, "makeStrictEnum"), objectEnumValues: /* @__PURE__ */ __name(() => Oe, "objectEnumValues") });
    module.exports = Ke(Xn);
    var he = {};
    Me(he, { validator: /* @__PURE__ */ __name(() => Ce, "validator") });
    function Ce(...e) {
      return (n) => n;
    }
    __name(Ce, "Ce");
...
In case this error is unexpected for you, please report it in https://pris.ly/prisma-prisma-bug-report`
    ...
    exports.Prisma.AdDirectiveScalarFieldEnum = {
      id: "id",
      makeModelKey: "makeModelKey",
      ref: "ref",
      summary: "summary",
    ...
    exports.Prisma.EventLiveScalarFieldEnum = {
      id: "id",
      tail: "tail",
      ts: "ts",
      lat: "lat",
    ...
    exports.Prisma.WeatherMetarScalarFieldEnum = {
      id: "id",
      icao: "icao",
      ts: "ts",
      raw: "raw",
...
// .wrangler/tmp/bundle-7ehyWE/middleware-loader.entry.ts
init_checked_fetch();

// .wrangler/tmp/bundle-7ehyWE/middleware-insertion-facade.js
init_checked_fetch();
    ...
    try {
      ...
      if (aircraft.length > 0) {
        const results = aircraft.map((a) => ({
          ...
          // TODO: Calculate real risk score
        }));
        return new Response(JSON.stringify({
          results,
...
async function handleAircraftSummary(request) {
  try {
    const url = new URL(request.url);
...
__name(handleAircraftSummary, "handleAircraftSummary");
async function handleLiveTracking(request) {
  try {
    const url = new URL(request.url);
    ...
    try {
      ...
      if (livePositions.length > 0) {
        const positions = livePositions.map((pos, i) => ({
          id: i + 1,
          tail: pos.tail,
          lat: pos.lat,
          lon: pos.lon,
    ...
    const mockLiveData = {
      positions: Array.from({ length: limit }, (_, i) => ({
        ...
        alt: 3e3 + Math.random() * 12e3,
        speed: 100 + Math.random() * 250,
        heading: Math.random() * 360,
        ts: new Date(Date.now() - Math.random() * minutes * 60 * 1e3).toISOString(),
        aircraft: {
...
__name(handleLiveTracking, "handleLiveTracking");
var src_default = {
  async fetch(request) {
    const url = new URL(request.url);
...
// ../../node_modules/.pnpm/wrangler@4.38.0_@cloudflare+workers-types@4.20250917.0/node_modules/wrangler/templates/middleware/middleware-ensure-req-body-drained.ts
init_checked_fetch();
...
// ../../node_modules/.pnpm/wrangler@4.38.0_@cloudflare+workers-types@4.20250917.0/node_modules/wrangler/templates/middleware/middleware-miniflare3-json-error.ts
init_checked_fetch();
...
// ../../node_modules/.pnpm/wrangler@4.38.0_@cloudflare+workers-types@4.20250917.0/node_modules/wrangler/templates/middleware/common.ts
init_checked_fetch();
