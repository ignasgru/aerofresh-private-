            ...
            try {
                ...
                switch (msg.body.kind) {
                    ...
                    case "LIVE_ADS_B":
                        ...
                        break;
                    default:
                        console.warn(`[ETL Consumer] Unknown job type: ${msg.body.kind}`);
                }
                msg.ack();
...
async function syncAirports(pg) {
...
async function syncWeatherMETAR(pg) {
...
async function syncLiveADS_B(pg) {
