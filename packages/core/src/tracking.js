...
export class FlightTracker {
    ...
    async getOpenSkyPositions(icao24) {
        const url = icao24
    ...
    async getADSBExchangePositions(icao24) {
        const url = icao24
    ...
    async getAircraftTrack(icao24, hours = 1) {
    ...
    async getAircraftInArea(lat, lon, radiusKm = 100) {
        try {
    ...
    async getFlightPath(origin, destination) {
...
export function icao24ToTail(icao24) {
...
export function getAircraftType(icao24) {
